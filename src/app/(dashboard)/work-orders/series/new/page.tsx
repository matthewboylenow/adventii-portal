...
export default async function NewSeriesPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Create Work Order Series</h1>
        <p className="text-gray-600 mt-1">
          Create multiple work orders at once for recurring events
        </p>
      </div>

      <SeriesForm services={services} staff={allStaff} approvers={approvers} />
    </div>
  );
}
